...
<body>
    ...
    <div class="">
        <h3 class="text-center text-primary mt-3">Recommended products</h3>
    </div>

    <!-- home page body section -->
    <div class="row w-[96%] mx-auto px-4 my-3">
        <div class="col-md-10">
            <!-- product section -->
        ...
        <div class="col-md-2 text-center bg-dark bg-body-secondary p-0 mb-3">
            <!-- category section -->
